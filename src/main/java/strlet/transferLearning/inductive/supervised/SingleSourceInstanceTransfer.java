 ...
 * instance transfer classifiers with a single source domain and a single target domains.  
 *
 * In the instance transfer paradigm, both domains share the same 
 * set of features and labels and a feature weighing or elimination 
 * is performed on the source examples to add to the target examples
 * during the learning stage.
 *
 * @author Noam Segev (nsegev@cs.technion.ac.il)
 */
public abstract class SingleSourceInstanceTransfer extends SingleSourceTransfer {
