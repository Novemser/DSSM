 ...
 * examples (using Wekas' J48 implementation), following a C4.5-style tree
 * pruning using the target examples as validation.
 * <p/>
 * <!-- globalinfo-end -->
 * 
 ...
 *
 */
public class PruningTree extends SingleSourceModelTransfer implements
	...
	public SingleSourceTransfer makeDuplicate() throws Exception {
		PruningTree dup = new PruningTree();
		dup.setSeed(getSeed());
		if (m_root == null) {
			dup.m_root = null;
		} else {
